 ...
 */
public interface SearchSuggestionsPortletPreferences {
	...
	public static final String
		PREFERENCE_KEY_RELATED_SUGGESTIONS_DISPLAY_THRESHOLD =
			"relatedSuggestionsDisplayThreshold";

	public static final String PREFERENCE_KEY_RELATED_SUGGESTIONS_ENABLED =
		"relatedSuggestionsEnabled";

	public static final String PREFERENCE_KEY_RELATED_SUGGESTIONS_MAX =
		"reltedSuggestionsMax";
