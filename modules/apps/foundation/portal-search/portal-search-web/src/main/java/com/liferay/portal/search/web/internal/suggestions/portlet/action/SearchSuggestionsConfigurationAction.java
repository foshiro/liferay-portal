...
@Component(
	immediate = true,
	property = "javax.portlet.name=" + SearchSuggestionsPortletKeys.SEARCH_SUGGESTIONS,
	service = ConfigurationAction.class
)
public class SearchSuggestionsConfigurationAction
	extends DefaultConfigurationAction {

	@Override
	public String getJspPath(HttpServletRequest request) {
		return "/search/suggestions/configuration.jsp";
	}
