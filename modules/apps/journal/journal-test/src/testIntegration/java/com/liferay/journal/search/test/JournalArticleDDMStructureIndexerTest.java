...
import com.liferay.dynamic.data.mapping.test.util.background.task.TestDDMStructureBackgroundTask;
...
public class JournalArticleDDMStructureIndexerTest {
	...
	public void testDisableJournalArticleIndexer()
		...
		DDMStructure ddmStructure =
			journalArticleDDMStructureFixture.
				createDDMStructureWithJournalArticle(title, locale);
	...
	protected void runBackgroundTaskReindex(DDMStructure structure)
		...
		TestDDMStructureBackgroundTask backgroundTask =
			new TestDDMStructureBackgroundTask(structure.getStructureId());
	...
	protected void setUpJournalArticleDDMStructureFixture() throws Exception {
		journalArticleDDMStructureFixture =
			new JournalArticleDDMStructureFixture(
				group, journalArticleLocalService);

		ddmStructures = journalArticleDDMStructureFixture.getStructures();

		ddmTemplates = journalArticleDDMStructureFixture.getTemplates();
	}
	...
	protected JournalArticleDDMStructureFixture
		journalArticleDDMStructureFixture;
