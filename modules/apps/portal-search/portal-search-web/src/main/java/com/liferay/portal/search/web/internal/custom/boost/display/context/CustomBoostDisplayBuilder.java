 ...
 * @author Luan Maoski
 */
public class CustomBoostDisplayBuilder {

	public CustomBoostDisplayContext build() {
		CustomBoostDisplayContext customFilterDisplayContext =
			new CustomBoostDisplayContext();
