 ...
 */
public class DDMFormFieldEvaluatorHelper {

	public DDMFormFieldEvaluatorHelper(
	...
	public List<DDMFormFieldEvaluationResult> evaluateField(
		DDMFormField ddmFormField)
	throws PortalException {

		return evaluateDDMFormFieldValues(
			ddmFormField, _rootDDMFormFieldValues,
			new HashSet<DDMFormFieldValue>());
	}
