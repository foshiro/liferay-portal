...
public class DDMFormFieldEvaluatorTest extends BaseDDMServiceTestCase {
	...
	public void testValidFields() throws Exception {
		...
		Map<String, DDMFormField> formFields = ddmForm.getDDMFormFieldsMap(
			false);
		...
		DDMFormFieldEvaluator ddmFormFieldEvaluator = registry.getService(
			DDMFormFieldEvaluator.class);

		List<DDMFormFieldEvaluationResult> ddmFormFieldEvaluationResults =
			ddmFormFieldEvaluator.evaluate(
				ddmForm, formFields.get("Text"), ddmFormValues, LocaleUtil.US);
